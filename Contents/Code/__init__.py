      ...
      if anime:
        ...
        if not movie: ### TV Serie specific #################################################################################################################
          ...
          for episode in anime.xpath('episodes/episode'):   ### Episode Specific ###########################################################################################
            ...
            if tvdbid.isdigit():
              if mappingList.get('episodeoffset', None) == '':
                mappingList['episodeoffset'] = '0'
              ...
              else:                                                                tvdb_ep = "s"+defaulttvdbseason+"e"+ str(int(epNumVal) + int(mappingList.get('episodeoffset', 0)))
